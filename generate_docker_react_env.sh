...
if [[ "${ENVIRONMENT}" = 'production' ]];then
    DEBUG=1
    REACT_APP_EXPOSE_PORT=3001
    REACT_APP_BASE_URL=http://172.18.0.3:8001
elif [[ "${ENVIRONMENT}" = 'development' ]];then
    DEBUG=1
    REACT_APP_EXPOSE_PORT=3002
    REACT_APP_BASE_URL=http://172.18.0.3:8002
elif [[ "${ENVIRONMENT}" = 'development_test' ]];then
    DEBUG=1
    REACT_APP_EXPOSE_PORT=3003
    REACT_APP_BASE_URL=http://172.18.0.3:8003
elif [[ "${ENVIRONMENT}" = 'production_test' ]];then
    DEBUG=1
    REACT_APP_EXPOSE_PORT=3004
    REACT_APP_BASE_URL=http://172.18.0.3:8004
else
